...
def lambda_handler(event, context):
    cities = ["Islamabad", "Rawalpindi", "Lahore", "Karachi", "Peshawar", "Quetta", "Multan", "Faisalabad", "Sialkot", "Gujranwala"]
    #cities = ["Bangalore","Delhi","Mumbai","Chennai","Kashmir","Dehradun","Kochi","Kerela","Hyderabad","Sikkim"]
    #cities = ["Islamaabad","Rawalpindi","Chakwal","Lahore","Karachi","Quetta"]
    for city in cities:
